...
//     // actual seed: seed + prime * step

//     steps_to_go: u32,
//     steps_back: u32,

//     // if steps_to_go > 0: seed = steps back

//     // or have 2 random processes, one that randomly resets the first one
...
// impl RGBRec {
//     pub fn new(w: usize, h: usize, seed: u32) -> RGBRec {
